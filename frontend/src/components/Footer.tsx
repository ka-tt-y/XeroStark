...
const Footer: React.FC = () => {
	return (
		<footer className="border-t border-gray-800 bg-dark-900/80 light:bg-white/80 light:border-gray-200">
				...
				<div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
					...
					<div>
						...
						<ul className="space-y-2.5">
							<li>
								<Link to="/templates" className="text-sm text-gray-400 hover:text-primary transition-colors">
									Templates
								</Link>
							</li>
							<li>
					...
					<div>
						...
						<ul className="space-y-2.5">
							<li>
								<a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-sm text-gray-400 hover:text-primary transition-colors flex items-center gap-1.5">
							...
							<li>
								<a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-sm text-gray-400 hover:text-primary transition-colors flex items-center gap-1.5">
