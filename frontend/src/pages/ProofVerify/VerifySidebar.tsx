...
const VerifySidebar: React.FC<VerifySidebarProps> = ({ deployedAddress }) => (
	<div className="lg:col-span-2 space-y-5 mt-19 ml-10">
		...
		<div className="card p-5 border-cyan-500/20 bg-cyan-500/5">
			<div className="flex items-start gap-3">
				...
				<div>
					<h4 className="text-xs font-semibold text-cyan-400 mb-1">What happens?</h4>
					<p className="text-xs text-gray-400 leading-relaxed">
						A transaction is sent to the verifier contract on Starknet. The smart contract checks the proof using <strong className="text-gray-300">Groth16 pairing verification</strong> — if valid, it's recorded permanently on-chain.
					</p>
				</div>
			</div>
		</div>
